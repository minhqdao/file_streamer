...
* **SDK floors**: Dart `^3.10.0`.
* **Fix**: Files that vanish between picking and reading now fail at pick time with a `FilePickerException` naming the path, instead of surfacing later as a stream error.
